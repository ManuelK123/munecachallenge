...
function iniciarNivel7EscaleraMapa() {
    ...
    const duracionFade = 120; // 4 segundos totales de efecto (60fps)[cite: 17]

    let uiContainer = document.getElementById('ui');
    uiContainer.innerHTML = `
        <div style="font-size: 13px; color: #fff; text-shadow: 2px 2px 4px #000;">Zona: <span id="stage-name-txt">pioa</span></div>
        <div id="hearts-container" style="font-size: 14px; letter-spacing: 1px; color: #ff3366; text-shadow: 2px 2px 4px #000;">❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️</div>
    `;
